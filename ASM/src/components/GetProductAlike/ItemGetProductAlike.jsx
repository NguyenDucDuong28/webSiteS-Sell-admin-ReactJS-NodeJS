...
const ItemGetProductAlike = ({items}) => {
    return (
        <div className=" ">
            ...
            <div className="relative">
                <Image className="max-h-[168px] absolute top-[35px] left-[65px]" src={items?.hinh}  />
            </div>
            ...
            <div>
                <p className='line-through text-sm text-color-price'></p>
            </div>
            </div>
...
export default ItemGetProductAlike;